...
export class VentaDetallePage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad VentaDetallePage');
    this.listarP();
  }
  ...
  verProducto(id) {
    ...
    /* console.log(id)
    var idPrecio = document.getElementById("precio");
    var contenido = document.createTextNode("25");
    idPrecio.appendChild(contenido); */
  }
  calcular() {
    ...
    /* this.actualizarVenta(this.ventaNueva, this.idVenta); */
  }
